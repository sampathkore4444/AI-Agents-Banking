"""
RAG Pipeline for KYC Onboarding Agent.

Provides hybrid search (BM25 + semantic), re-ranking, and context assembly
over banking knowledge stored in ChromaDB collections.
"""
