"""
RAG Pipeline for Financial Statement Analysis Agent.

Provides hybrid search over accounting standards, analytical frameworks,
industry benchmarks, ratio definitions, credit analysis methodologies,
financial statement structures, and regulatory reporting requirements.
"""
...
class RAGPipeline:
    ...
    def _assemble_context(self, chunks: list[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            source = chunk.metadata.get("source", chunk.metadata.get("category", chunk.collection))
