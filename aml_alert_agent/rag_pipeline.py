"""
RAG Pipeline for Anti-Money Laundering (AML) Alert Agent.

Provides hybrid search over AML regulations, red flag typologies,
SAR filing guidelines, PEP information, beneficial ownership rules,
and sanctions lists.
"""
...
class RAGPipeline:
    ...
    def _assemble_context(self, chunks: list[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            source = chunk.metadata.get("source", chunk.metadata.get("section", chunk.collection))
