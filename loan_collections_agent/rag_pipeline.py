"""
RAG Pipeline for Loan Collections Agent.

Provides hybrid search over FDCPA regulations, collection strategies,
negotiation frameworks, compliance guidelines, and past resolution cases.
"""
...
class RAGPipeline:
    ...
    def _assemble_context(self, chunks: list[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            source = chunk.metadata.get("source", chunk.metadata.get("strategy", chunk.collection))
