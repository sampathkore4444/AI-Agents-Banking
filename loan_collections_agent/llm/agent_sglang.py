...
class SGLangAgent(BaseAgent):
    """
    Loan Collections Agent powered by SGLang.
...
# ── Structured Output Schemas for Collections ─────────────────────
...
STRATEGY_RECOMMENDATION_SCHEMA = {
    ...
    "json_schema": {
        ...
        "schema": {
            "type": "object",
            "properties": {
                "stage": {"type": "string", "enum": ["early_stage", "mid_stage", "late_stage", "charge_off"]},
            ...
            "required": ["stage", "recommended_approach", "actions", "compliance_notes", "recovery_probability", "reasoning"],
        },
    },
}
...
COMPLIANCE_CHECK_SCHEMA = {
    ...
    "json_schema": {
        ...
        "schema": {
            ...
            "required": ["compliant", "violations", "warnings", "recommendation"],
        },
    },
}
...
async def main():
    ...
    print("Loan Collections Agent ready. Type 'quit' to exit.\n")
