"""
RAG Pipeline for Internal Knowledge Base Agent.

Provides hybrid search over internal banking knowledge:
...
class RAGPipeline:
    ...
    def query(
        self, user_query: str, n_results_per_collection: int = 5, top_k: int = 5,
