"""
RAG Pipeline for Real-Time Transaction Fraud Detection Agent.

Provides hybrid search over fraud regulations, fraud typologies,
detection rules, investigation playbooks, and case precedents.
"""
