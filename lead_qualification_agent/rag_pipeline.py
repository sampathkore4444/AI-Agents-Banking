"""
RAG Pipeline for Lead Qualification Agent.

Provides hybrid search over qualification criteria, sales playbooks,
lead scoring models, and conversion patterns.
"""
