"""
RAG Pipeline for Standing Order & Bill Payment Agent.

Provides hybrid search over standing order policies, biller information,
payment scheduling rules, recurring payment compliance, and customer
billing knowledge.
"""
