"""
RAG Pipeline for Product Recommendation Agent.

Provides hybrid search over product catalog, eligibility criteria,
cross-sell rules, promotional offers, and customer segmentation.
"""
