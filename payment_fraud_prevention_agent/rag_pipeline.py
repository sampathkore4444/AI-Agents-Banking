"""
RAG Pipeline for Payment Fraud Prevention Agent.

Provides hybrid search over payment fraud policies, wire fraud patterns,
ACH fraud typologies, BEC schemes, check fraud, real-time payment risks,
