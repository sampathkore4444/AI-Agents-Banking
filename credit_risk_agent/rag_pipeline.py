"""
RAG Pipeline for Credit Risk Monitoring Agent.

Provides hybrid search over risk policies, Basel requirements,
credit review procedures, and default patterns.
"""
