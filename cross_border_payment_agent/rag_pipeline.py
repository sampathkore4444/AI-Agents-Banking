"""
RAG Pipeline for Cross-Border Payment Assistant Agent.

Provides hybrid search over correspondent banking, SWIFT codes,
country regulations, fee schedules, and FX trading rules.
"""
...
class RAGPipeline:
    ...
    def _assemble_context(self, chunks: list[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            source = chunk.metadata.get("source", chunk.metadata.get("country", chunk.collection))
