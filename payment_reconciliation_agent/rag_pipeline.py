"""
RAG Pipeline for Payment Reconciliation Agent.

Provides hybrid search over reconciliation rules, payment standards,
exception handling procedures, and accounting guidelines.
"""
...
class RAGPipeline:
    ...
    def _assemble_context(self, chunks: list[RetrievedChunk]) -> str:
        ...
        for i, chunk in enumerate(chunks, 1):
            source = chunk.metadata.get("source", chunk.metadata.get("standard", chunk.collection))
