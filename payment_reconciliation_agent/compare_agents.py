...
Runs the same reconciliation query against Ollama, vLLM, and SGLang,
...
TEST_QUERIES = [
    "What are the matching criteria for payment reconciliation?",
    "I need to reconcile a bank statement against our ledger. What's the process?",
    "Explain the BAI2 format for cash management reporting.",
]
...
async def compare():
    ...
    print("=" * 70)
    print("Payment Reconciliation Agent — LLM Backend Comparison")
    print("=" * 70)
